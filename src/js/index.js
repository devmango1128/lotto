let LOTTO = {
    ...
    , fn_font_size_change: function(factor) {
        ...
        alert(getComputedStyle(html).fontSize + factor);
        html.dataset.fontSize = getComputedStyle(html).fontSize + factor;
        html.style.fontSize = getComputedStyle(html).fontSize + factor + 'px';
    }
    //화면사이즈변경
